...
**Current ISO Version:** `250422`

**SHA256 Hash:** `c87272fc0e8476ea187005d416fa0ee7630a50c71c097233960a0fee22cb8bfe`
...
1. Download the [file](https://mirror.cachyos.org/ISO/desktop/250422/cachyos-desktop-linux-250422.iso.sha256) containing the SHA256 hash **(Open it with a Text Editor e.g: Notepad).**
